...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-05-2021 a las 14:52:47
...
--
INSERT INTO
  `tm_admin` (`user`, `hash`, `date_added`)
VALUES
  (
    'malena',
    '$2y$10$2EX7lxGNe85KjjIJE0UAUu9wNvanQg8vkTL3r4.GvYLIig9EFd6vS',
    '2021-05-17 09:29:27'
  ),
  (
    'maroto',
    '$2y$10$8Fq5giHUIvnFphTa1Wp1B.zjcN/03RegUBILGzn2gDN0Il08YZdmC',
    '2021-05-17 09:29:27'
  ),
  (
    'mori',
    '$2y$10$20lBDOl2uMuD6WQnEBJ2iOqz0bAZps450DONxphuUlSmt67oMWVza',
    '2021-05-17 09:29:27'
  );
...
--
CREATE TABLE `tm_lang` (`lang` varchar(2) NOT NULL) ENGINE = InnoDB DEFAULT CHARSET = utf8;
...
--
INSERT INTO
  `tm_partial` (`partial_name`, `lang`, `content`)
VALUES
  (
    'footer',
    'en',
...
--
--
-- Filtros para la tabla `tm_access`
--
ALTER TABLE
  `tm_access`
ADD
  CONSTRAINT `tm_access_ibfk_1` FOREIGN KEY (`admin`) REFERENCES `tm_admin` (`user`);
...
ALTER TABLE
  `tm_page`
ADD
  CONSTRAINT `tm_page_ibfk_1` FOREIGN KEY (`lang`) REFERENCES `tm_lang` (`lang`);
...
ALTER TABLE
  `tm_partial`
ADD
  CONSTRAINT `tm_partial_ibfk_1` FOREIGN KEY (`lang`) REFERENCES `tm_lang` (`lang`);
