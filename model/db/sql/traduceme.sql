...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-05-2021 a las 08:23:30
...
(21, 'mori', '2021-05-24 10:06:51', 1, '************'),
(22, 'mori', '2021-05-28 14:01:26', 1, '************'),
(23, 'mori', '2021-05-31 08:08:30', 1, '************');
...
ALTER TABLE `tm_page`
  ...
  ADD CONSTRAINT `tm_page_ibfk_2` FOREIGN KEY (`user`) REFERENCES `tm_admin` (`user`);
