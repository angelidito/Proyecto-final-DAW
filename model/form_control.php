...
class FormControl
{
    ...
    public static function checkPage_Name($page_name)
    {
        ...
        if (!preg_match("/^[a-zA-Z]([-]?[a-zA-Z]?[\d]?){4,39}$/", $page_name)) {
            throw new DatoInvalidoException("Error: el nombre de la página debe empezar por una letra y contener solalmente letras, número y guiones (\"-\"). ");
        }
