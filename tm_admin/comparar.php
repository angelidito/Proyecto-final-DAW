            ...
            <div class="row ">
                <div class="col-md-6 pr-1">
                    ...
                    <div class="form-group text-center <?php echo $hidden_partial ?>">
                        ...
                        <input id="title_editar_es" class="form-control text-center " type="text" name="title_es" <?php echo $hidden_partial == '' ? "minlength=5 maxlength=70 value='$title_es'" : $hidden_partial ?>>
                    </div>
                </div>
                <div class="col-md-6 pl-1">
                    ...
                    <div class="form-group text-center <?php echo $hidden_partial ?>">
                        ...
                        <input id="title_editar_en" class="form-control text-center" type="text" name="title_en" <?php echo $hidden_partial == '' ? "minlength=5 maxlength=70 value='$title_en'" : $hidden_partial; ?>>
                    </div>
                </div>
            </div>
        </div>
