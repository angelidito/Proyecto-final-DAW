...
<main class="my-4 py-4 center">
    ...
    <div id="elegir" class="container mb-4 ">
            ...
            <div class="row">
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <select id="page_name" class="form-control" name="page_name">
                            <option value="es">ejemplo</option>
                            <option value="es">ejemplo</option>
                            <?php
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <select id="lang" class="form-control center text-center" name="lang">
        ...
        <form method="post" action="">
            <div class="row">
                <div class="col-md-4 ">
                    <div class="form-group">
                        <label for="page_name">Nombre de la página</label>
                        <input class="form-control" type="text" name="page_name" value="ejemplo<?php $paginas ?>" readonly>
                    </div>
                ...
                <div class="col-md-4 ">
                    <div class="form-group">
                        ...
                        <select id="lang" class="form-control center text-center" name="lang" readonly>
                            <option value="<?php $lang ?>">ejemplo</option>
                        </select>
                    </div>
